...
namespace InvyNest_API.Migrations
{
    ...
    [Migration("20250822135024_WorkspaceItemSingleKey")]
    partial class WorkspaceItemSingleKey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InvyNest_API.Domain.WorkspaceItem", b =>
                {
                    ...
                    b.Property<Guid?>("ParentWorkspaceItemId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ParentWorkspaceItemId");
            ...
            modelBuilder.Entity("InvyNest_API.Domain.WorkspaceItem", b =>
                {
                    ...
                    b.HasOne("InvyNest_API.Domain.WorkspaceItem", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentWorkspaceItemId")
                        .OnDelete(DeleteBehavior.Restrict);
